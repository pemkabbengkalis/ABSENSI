...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-dashboard"></i>Operator SKPD</h1>
      <p>Untuk mengatur Operator SKPD</p>
    </div>
...
<div class="col-12">
  <div class="card">
    ...
    <a  data-toggle="modal" data-target="#tambah" style="color:white;float:right"class="btn waves-effect waves-light btn-primary">Tambah Data</a>
      <h4 class="card-title">Data Operator SKPD</h4>

      <h6 class="card-subtitle">Data ini digunakan untuk menambahkan data Operator SKPD</h6>
      <!-- Modal -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <select class="form-control" name="level" required>
                ...
                <?php
                  $level = App\Level::where('level','user')->get();
                 ?>
